...
public class LoadHpa {
	...
	// static String fileLocation = args[0];
					...
					while (xmlStreamReader.hasNext()) {
						...
						if (XMLStreamConstants.END_ELEMENT == eventCode
							...
							if (XMLStreamConstants.START_ELEMENT == eventCode
								...
								//if(ElementNode.identifier.contains("ENSG")){
									//String Gene_ID= ElementNode.identifier;

								Individual geneIndividual = ontoModel.createIndividual(PROTEINATLAS.Gene, Gene++);
								//}
								//Individual identifierIndividual2 = ontoModel
										...
										if (XMLStreamConstants.START_ELEMENT == eventCode) {
											if (xmlStreamReader.getLocalName().equalsIgnoreCase(ElementNode.name)) {
												...
												Individual identifierIndividual = ontoModel
														.createIndividual(PROTEINATLAS.Identifier, Identifier++);
												//Identifier++;
												System.out.println("identifierIndividual in the Gene class: "  + identifierIndividual);
												geneIndividual.addProperty(
														ontoModel.getProperty(PROTEINATLAS.isIdentifiedBy),
												...
												for (int i = 0; i < identifierAttributesCount; i++) {
													...
													if (attribute.equalsIgnoreCase(PROTEINATLAS.ID)) {
														//if(attribute.equals("ENSG00000026508"){
												...
												while (xmlStreamReader.hasNext()) {
													...
													if (XMLStreamConstants.END_ELEMENT == eventCode
														...
														if (XMLStreamConstants.START_ELEMENT == eventCode
																&& xmlStreamReader.getLocalName()
																		.equalsIgnoreCase(ElementNode.proteinClass)) {
															Individual proteinClassIndividual = ontoModel
																	.createIndividual(PROTEINATLAS.ProteinClass,
																			ProteinClass++);
															geneIndividual.addProperty(
																	ontoModel.getProperty(PROTEINATLAS.hasProteinClass),
															...
															for (int i = 0; i < proteinClassAttributesCount; i++) {
																...
																String value = xmlStreamReader.getAttributeValue(i);
																//System.out.println("Value in the Gene class: "  + value);
																if (attribute.equalsIgnoreCase(PROTEINATLAS.ID)) {
												...
												while (xmlStreamReader.hasNext()) {
													...
													if (XMLStreamConstants.END_ELEMENT == eventCode
														...
														if (XMLStreamConstants.START_ELEMENT == eventCode
															...
															Individual evidenceIndividual = ontoModel.createIndividual(
																	PROTEINATLAS.Evidence, Evidence++);
															geneIndividual.addProperty(
															...
															for (int i = 0; i < evidenceAttributesCount; i++) {
																String attribute = xmlStreamReader
																		.getAttributeLocalName(i);
																String value = xmlStreamReader.getAttributeValue(i);
																if (attribute.equalsIgnoreCase(PROTEINATLAS.source)) {
																	evidenceIndividual.addLiteral(
																			ontoModel.getProperty(PROTEINATLAS.source),
																			value);
												...
												for (int i = 0; i < tissueExpressionClassAttributesCount; i++) {
													...
													} else if (attribute.equalsIgnoreCase(PROTEINATLAS.technology)) {
														tissueExpressionIndividual.addLiteral(
																ontoModel.getProperty(PROTEINATLAS.technology), value);
													} else if (attribute.equalsIgnoreCase(PROTEINATLAS.assayType)) {
														tissueExpressionIndividual.addLiteral(
																ontoModel.getProperty(PROTEINATLAS.assayType), value);
													}
												}
														...
														if (XMLStreamConstants.START_ELEMENT == eventCode) {
															if (xmlStreamReader.getLocalName()
																...
																tissueExpressionIndividual.addProperty(
																		ontoModel.getProperty(PROTEINATLAS.hasSummary),
																		summaryIndividual);
																...
																for (int i = 0; i < summaryAttributesCount; i++) {
																	...
																	String value = xmlStreamReader.getAttributeValue(i);
																	if (attribute.equalsIgnoreCase(PROTEINATLAS.type)) {
																		summaryIndividual.addLiteral(ontoModel
																				.getProperty(PROTEINATLAS.type), value);
																	}
																}
																String desc = xmlStreamReader.getElementText();
																summaryIndividual.addLiteral(
																		ontoModel.getProperty(PROTEINATLAS.description),
																		desc);
															} else if (xmlStreamReader.getLocalName()
																	.equalsIgnoreCase(ElementNode.verification)) {
																Individual verificationIndividual = ontoModel
																		.createIndividual(PROTEINATLAS.TE_Verification,
																				TE_Verification++);
																tissueExpressionIndividual.addProperty(
																		ontoModel.getProperty(
																...
																for (int i = 0; i < verificationAttributesCount; i++) {
																	...
																	String value = xmlStreamReader.getAttributeValue(i);
																	if (attribute.equalsIgnoreCase(PROTEINATLAS.type)) {
																		verificationIndividual.addLiteral(ontoModel
																				.getProperty(PROTEINATLAS.type), value);
																...
																String reliability = xmlStreamReader.getElementText();
																verificationIndividual.addLiteral(
																		ontoModel.getProperty(PROTEINATLAS.reliability),
																		reliability);
															} else if (xmlStreamReader.getLocalName()
																	.equalsIgnoreCase(ElementNode.image)) {

																Individual imageIndividual = ontoModel.createIndividual(
																		PROTEINATLAS.TE_Image, TE_Image++);
																tissueExpressionIndividual.addProperty(
																		ontoModel.getProperty(
																				PROTEINATLAS.hasVerification),
																		imageIndividual);
																...
																Individual dataIndividual = ontoModel.createIndividual(
																		PROTEINATLAS.TE_Data, TE_Data++);
																tissueExpressionIndividual.addProperty(
												...
												int cellExpressionAttributesCount = xmlStreamReader.getAttributeCount();
														...
														if (XMLStreamConstants.START_ELEMENT == eventCode) {
															if (xmlStreamReader.getLocalName()
																...
																cellExpressionIndividual.addProperty(
																		ontoModel.getProperty(PROTEINATLAS.hasSummary),
																		summaryIndividual);
																String description = xmlStreamReader.getElementText();
																summaryIndividual.addLiteral(
																		ontoModel.getProperty(PROTEINATLAS.description),
																		description);
															} else if (xmlStreamReader.getLocalName()
																...
																Individual verificationIndividual = ontoModel
																		.createIndividual(PROTEINATLAS.CE_Verification,
																				CE_Verification++);
																cellExpressionIndividual.addProperty(
																		ontoModel.getProperty(
																				PROTEINATLAS.hasVerification),
																...
																verificationIndividual.addLiteral(
																	...
																	.equalsIgnoreCase(ElementNode.image)) {
																Individual imageIndividual = ontoModel.createIndividual(
																		PROTEINATLAS.CE_Image, CE_Image++);
																cellExpressionIndividual.addProperty(
																		ontoModel.getProperty(PROTEINATLAS.hasImage),
																		imageIndividual);
												...
												Individual rnaExpressionIndividual = ontoModel
														.createIndividual(PROTEINATLAS.RnaExpression, RnaExpression++);
												geneIndividual.addProperty(
														ontoModel.getProperty(PROTEINATLAS.hasRnaExpression),
														rnaExpressionIndividual);
												int rnaExpressionAttributesCount = xmlStreamReader.getAttributeCount();
												...
												while (xmlStreamReader.hasNext()) {
													...
													if (XMLStreamConstants.END_ELEMENT == eventCode
														...
														if (XMLStreamConstants.START_ELEMENT == eventCode) {
															if (xmlStreamReader.getLocalName()
																	.equalsIgnoreCase(ElementNode.rnaTissueCategory)) {
																...
																String name = xmlStreamReader.getElementText();
																rnaTissueCategoryIndividual.addLiteral(
																		ontoModel.getProperty(PROTEINATLAS.name), name);
															} else if (xmlStreamReader.getLocalName()
																	.equalsIgnoreCase(ElementNode.data)) {
																Individual dataIndividual = ontoModel.createIndividual(
																		PROTEINATLAS.RE_Data, RE_Data++);
																rnaExpressionIndividual.addProperty(
																		ontoModel.getProperty(PROTEINATLAS.hasData),
																		dataIndividual);
																while (xmlStreamReader.hasNext()) {
												...
												while (xmlStreamReader.hasNext()) {
													eventCode = xmlStreamReader.next();
													if (XMLStreamConstants.END_ELEMENT == eventCode && xmlStreamReader
															.getLocalName().equalsIgnoreCase(ElementNode.antibody)) {
														break;
													} else {
														if (XMLStreamConstants.START_ELEMENT == eventCode) {
															if (xmlStreamReader.getLocalName()
																	.equalsIgnoreCase(ElementNode.antigenSequence)) {
																...
																antibodyIndividual.addLiteral(
																		...
																		antigenSequence);
															} else if (xmlStreamReader.getLocalName().equalsIgnoreCase(
																...
																for (int i = 0; i < tissueExpressionAttributesCount; i++) {
																	...
																	if (attribute.equalsIgnoreCase(
																		...
																		tissueExpressionIndividual.addLiteral(
																			...
																			.equalsIgnoreCase(PROTEINATLAS.assayType)) {
																		tissueExpressionIndividual
																				.addLiteral(
																						ontoModel.getProperty(
																...
																Individual westernBlotIndividual = ontoModel
																		.createIndividual(PROTEINATLAS.AB_WesternBlot,
																				AB_WesternBlot++);
																antibodyIndividual.addProperty(
																		ontoModel.getProperty(
																...
																Individual proteinArrayIndividual = ontoModel
																		.createIndividual(PROTEINATLAS.AB_ProteinArray,
																				AB_ProteinArray++);
																antibodyIndividual.addProperty(
																		ontoModel.getProperty(PROTEINATLAS.hasProtein),
	...
	public static void main(String[] args) {
		LoadHpa.load("C:/Exp/proteinatlas.xml");
