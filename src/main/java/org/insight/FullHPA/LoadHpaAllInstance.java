...
public class LoadHpaAllInstance {

	// the input file location
	private static final String fileLocation = "/home/rezkar/ontology/proteinatlas.xml";
						...
						if (XMLStreamConstants.END_ELEMENT == eventCode
							...
							if (XMLStreamConstants.START_ELEMENT == eventCode
								...
								if (process) {
									...
									//Property arg0;
									//Literal arg1;
									//geneIndividual.addLabel(PROTEINATLAS.Gene, baseInstnace);
