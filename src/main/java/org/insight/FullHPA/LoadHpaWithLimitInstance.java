...
public class LoadHpaWithLimitInstance {
									...
									if (process) {
										...
										while (xmlStreamReader.hasNext()) {
											...
											if (XMLStreamConstants.END_ELEMENT == eventCode && xmlStreamReader
													.getLocalName().equalsIgnoreCase(ElementNode.entry)) {
												break;
											} else {
												if (XMLStreamConstants.START_ELEMENT == eventCode) {
													if (xmlStreamReader.getLocalName()
															.equalsIgnoreCase(ElementNode.name)) {
														...
														geneIndividual.addLiteral(
																ontoModel.getProperty(PROTEINATLAS.geneSynonym),
																synonym);
													} else if (xmlStreamReader.getLocalName()
															.equalsIgnoreCase(ElementNode.identifier)) {
														Individual identifierIndividual = ontoModel.createIndividual(
																PROTEINATLAS.Identifier, Identifier++);
														geneIndividual.addProperty(
																ontoModel.getProperty(PROTEINATLAS.isIdentifiedBy),
																identifierIndividual);
														int identifierAttributesCount = xmlStreamReader
																.getAttributeCount();
																...
																if (XMLStreamConstants.START_ELEMENT == eventCode
																	...
																	for (int i = 0; i < proteinClassAttributesCount; i++) {
																		...
																		String value = xmlStreamReader
																				.getAttributeValue(i);
																		if (attribute
																				.equalsIgnoreCase(PROTEINATLAS.ID)) {
																			proteinClassIndividual
																					.addLiteral(
																							ontoModel.getProperty(
																									PROTEINATLAS.ID),
														...
														Individual tissueExpressionIndividual = ontoModel
																.createIndividual(PROTEINATLAS.TissueExpression,
																		TissueExpression++);
														geneIndividual.addProperty(
														...
														for (int i = 0; i < tissueExpressionClassAttributesCount; i++) {
															...
															if (attribute.equalsIgnoreCase(PROTEINATLAS.type)) {
																tissueExpressionIndividual.addLiteral(
																		ontoModel.getProperty(PROTEINATLAS.type),
																		value);
															} else if (attribute
														...
														Individual cellExpressionIndividual = ontoModel
																.createIndividual(PROTEINATLAS.CellExpression,
																		CellExpression++);
														geneIndividual.addProperty(
															...
															if (XMLStreamConstants.END_ELEMENT == eventCode
																...
																if (XMLStreamConstants.START_ELEMENT == eventCode) {
																	if (xmlStreamReader.getLocalName().equalsIgnoreCase(
																		...
																		String name = xmlStreamReader.getElementText();
																		rnaTissueCategoryIndividual.addLiteral(ontoModel
																				.getProperty(PROTEINATLAS.name), name);
																	} else if (xmlStreamReader.getLocalName()
																			.equalsIgnoreCase(ElementNode.data)) {
																		Individual dataIndividual = ontoModel
														...
														geneIndividual.addProperty(
																...
																antibodyIndividual);
														int antibodyAttributesCount = xmlStreamReader
																.getAttributeCount();
